                ...
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    <form action="{{ route('animais.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="especie" id="especie" class="mt-1 block w-full" required>
                        </div>
                        <div class="mb-4">
                            <label for="raca" class="block text-sm font-medium text-gray-700">Raça</label>
                            <input type="text" name="raca" id="raca" class="mt-1 block w-full" required>
                        </div>
                        <div class="mb-4">
                            <label for="data_chegada" class="block text-sm font-medium text-gray-700">Data de Chegada</label>
                            <input type="date" name="data_chegada" id="data_chegada" class="mt-1 block w-full" required>
                        </div>
                        <div class="mb-4">
